...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    '@whiveevo/whivecore-lib': '^' + whivecore.version,
    '@whiveevo/whivecore-node': version
  }
};

/**
 * Will create a directory and whive.conf file for Dash.
 ...
 * @param {String} options.datadir - The whive database directory
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/whivecore-node.json', configJSON);
      if (!isGlobal) {
 ...
 * whive configuration, and will install all necessary dependencies.
 *
 * @param {Object} options
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The name of the whivecore node configuration directory
 * @param {String} options.datadir - The path to the whive datadir
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the whivecore-node directory and configuration
